...
(function ($) {
    ...
    function togglePanel($wrap, $panel, $target, firstDir, secondDir)
    {
        ...
        if ($wrap.hasClass('mojosp-panel-visible')) {
            $wrap.addClass(secondDir+'-to-'+secondDir);
        } else {
            $panel.css('display', 'block');
            $wrap.addClass(secondDir+'-to-'+firstDir);
        }
        ...
        $wrap.on(transitionEnd, function () {
            ...
            {
                $wrap
                    .removeClass('mojosp-animating left-to-left left-to-right')
                    .toggleClass('mojosp-panel-visible');
            }
            else
            {
                $wrap
                    .removeClass('mojosp-animating right-to-left right-to-right')
                    .toggleClass('mojosp-panel-visible');
            }
    ...
    function setLeftAnimCSS()
    {
        ...
        var styleStr = "<style id='mojosp-style-animation-left' type='text/css'>\n\
                        .mojosp-animating.left-to-left {transform: translate3d( -"+leftWidth+"px, 0, 0 );\n\
                        -webkit-transform: translate3d( -"+leftWidth+"px, 0, 0 );}\n\
                        .mojosp-animating.left-to-right {\n\
    ...
    function setRightAnimCSS()
    {
        ...
        var styleStr = "<style id='mojosp-style-animation-right' type='text/css'>\n\
                        .mojosp-animating.right-to-left {transform: translate3d( -"+rightWidth+"px, 0, 0 );\n\
                        -webkit-transform: translate3d( -"+rightWidth+"px, 0, 0 );}\n\
                        .mojosp-animating.right-to-right {\n\
    ...
    $(window).resize(function () {
        ...
        if (leftOK)
        {
            if (resizeStarted)
            {
                ...
                $leftWrap.removeClass('mojosp-animating left-to-left left-to-right mojosp-panel-visible');
            }
        ...
        if (rightOK)
        {
            if (resizeStarted)
            {
                ...
                $rightWrap.removeClass('mojosp-animating right-to-left right-to-right mojosp-panel-visible');
            }
            setPanelPosition('right', 'hidden');
        }
